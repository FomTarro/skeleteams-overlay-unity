...
namespace Skeletom.Essentials.Localization
{
    public class LocalizationManager : Singleton<LocalizationManager>
    {
        ...
        public void AddStrings(Dictionary<string, string> strings, SupportedLanguage language)
        {
            ...
            Debug.Log("Added " + strings.Count + " strings to " + language + " table.");
            RefreshAllLocalizedText();
        }

        public void AddStrings(Dictionary<string, string> strings)
        {
            AddStrings(strings, CurrentLanguage);
        }
    ...
    /// 
    /// int value corresponds the column of the language in the source CSV file 
    // (therefore 1 indexed, as column 0 is the key list)
    /// </summary>
