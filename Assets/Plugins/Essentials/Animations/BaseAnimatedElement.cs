...
namespace Skeletom.Essentials.Animations
{
	...
	// TODO: This class is like legimitmately a decade old, definitely needs revision
	public abstract class BaseAnimatedElement : MonoBehaviour
	{

		protected const float UI_CYCLE_TIME = 0.35f;
		...
		protected bool Terminated { get { return _terminateAnimation; } }
